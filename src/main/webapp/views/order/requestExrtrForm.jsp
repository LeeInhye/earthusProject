		  ...
		  <div class="table-responsive">
			...
			<div class="re-info">
			  ...
			  <div id="re1">
				<h4>교환/반품 선택</h4>
				<hr>
				<span><input type="radio" name="select" onclick="showDiv(this);" checked> 교환</span> <br><br>
				<span><input type="radio" name="select" id="tb" onclick="showDiv(this);"> 반품</span>
			  </div>
			  <br><br>
			...
			<div align="center">
			  <button id="en-btn" type="submit">신청</button>
			</div>
		  </div>
		</div>
	</section>
