...
<body>
   ...
   <div class="container">
        <br><br><br><br><br><br>
        <div>
            <h2 class="menu_sub_title menu_sub_margin">Q&A 내역 > 수정</h2> <br>
		...
		<form action="<%= contextPath%>/mpUpdate.qa" method="post" enctype="multipart/form-data" id='mpQnaUpdateForm'>
	        ...
	        <div class="container qna_insert" style="width:90%;">
	            ...
	            <p style="color:gray; font-weight:300">
