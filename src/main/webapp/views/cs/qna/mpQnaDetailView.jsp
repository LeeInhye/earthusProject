...
<body>
   ...
   <div class="container">
		...
		<form action="<%= contextPath %>/mpDelete.qa" method="post">
	        ...
	        <div class="container" style="width:80%;">
	            ...
	            <div class="qna_detail_btn">
	                <button type="button" class="btn btn_gray"
	                	onclick="location.href='<%= contextPath %>/mpUpdateForm.qa?qno=<%= q.getQnaNo() %>';"
	                >수정</button>
	            ...
	            <div style="text-align: center;">
	                <button type="button" class="btn btn_green btn-lg" style="width:40%;" onclick="location.href='<%= contextPath %>/mpList.qa?mqpage=1';">목록으로 돌아가기</button>
	            </div>
