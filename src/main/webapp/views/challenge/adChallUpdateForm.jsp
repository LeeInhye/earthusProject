<%@ page language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8" import="com.us.common.model.vo.Attachment, com.us.challenge.model.vo.Challenge" %>
<%
        ...
        <div id="layoutSidenav_content">
            <main>
                <div class="container-fluid px-4">
                    <br>
                    <h3 class="mt-4" style="font-weight:bold;">챌린지 관리 > 수정</h3>
                    <hr><br>
                    <div class="enrollForm">
                        <form action="<%=contextPath%>/update.ch" method="post" id="updateForm" enctype="multipart/form-data">
                        	<input type="hidden" name="no" value="<%= ch.getChallNo() %>">
                        	<input type="hidden" name="originThumbnail" value="<%= ch.getChallThumbnail() %>">
                        	<input type="hidden" name="originFileNo" value="<%= at.getFileNo() %>" >
                        	
                            <p>제목</p>
                            <input type="text" name="title" style="width:700px" required value="<%= ch.getChallTitle() %>">
                            <br><br>

                            <p>내용</p>
                            <textarea name="content" rows="10" style="width:700px; resize: none;"><% if(ch.getChallContent() != null) { %><%= ch.getChallContent() %><% } %></textarea>
                            <br><br>
