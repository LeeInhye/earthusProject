...
/**
 * Servlet implementation class AdQnaListController
 */
@WebServlet("/adList.qa")
public class AdQnaListController extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		listCount = new QnaService().selectAdListCount();
		...
		ArrayList<Qna> list = new QnaService().selectAdQnaList(pi);
		...
		if(loginUser == null) {
			...
			request.getRequestDispatcher("/views/cs/qna/adQnaListView.jsp").forward(request, response);
		}
	}
