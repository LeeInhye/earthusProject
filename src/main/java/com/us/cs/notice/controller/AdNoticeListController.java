...
/**
 * Servlet implementation class AdNoticeListController
 */
...
public class AdNoticeListController extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		ArrayList<Notice> list = new NoticeService().selectAdNoticeList(pi);
		...
		if(loginUser == null) {
			...
			request.getRequestDispatcher("/views/cs/notice/adNoticeListView.jsp").forward(request, response);
		}
	}
