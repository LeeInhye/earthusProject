...
/**
 * Servlet implementation class adCmntListController
 */
@WebServlet("/adCmntMain.ch")
public class adCmntChallListController extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public adCmntChallListController() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		ArrayList<Challenge> list = new ChallengeService().selectAdList(pi);
		...
		if(loginUser == null) {
	    	...
	    	request.getRequestDispatcher("views/challenge/adCmntListView.jsp").forward(request, response);	    	
	    }
