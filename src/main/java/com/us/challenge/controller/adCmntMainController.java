...
public class adCmntMainController extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public adCmntMainController() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(loginUser == null) {
	    	...
	    	request.getRequestDispatcher("views/challenge/adCmntMainView.jsp").forward(request, response);	    	
	    }
